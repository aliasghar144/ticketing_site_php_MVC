...
<div class="grid">
    ...
    <form id="signup_form_user" action="<?php echo URL ?>auth/login_user" method="POST" class="form login">
        <div class="signup-heading">Login as User</div>
    ...
    <p class="text--center">you dont have account <a href="<?php echo URL . 'auth/userregister' ?>"> Register now</a></p>
    <a class="btn btn-primary" href="<?php echo URL . 'auth/companylogin' ?>" role="button">login as company</a>
